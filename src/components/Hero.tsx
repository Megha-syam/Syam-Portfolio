...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen flex items-center pt-16 bg-gradient-to-br from-background to-secondary/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center order-1 md:order-2">
            <div className="relative">
              <div className="w-60 h-60 md:w-80 md:h-80 overflow-hidden rounded-full border-4 border-white shadow-lg">
                <img
                  src="/lovable-uploads/7be8f80f-5a16-41ec-bea9-95be354116ee.png"
                  alt="Kambhampati Megha Syam"
                  className="w-full h-full object-cover object-center"
                />
              </div>
              <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white rounded-full py-2 px-4 shadow-md">
                <p className="text-navy font-medium">B.Tech CS Student</p>
              </div>
            </div>
          </div>
        </div>
